...
const Sidebar = () => {
  ...
  return (
    <div className="fixed hidden h-full flex-col items-center p-2 sm:flex xl:w-[340px]">
      <div
        className="hoverAnimation flex h-14 w-14 items-center justify-center p-0 xl:ml-24"
        onClick={() => router.push("/")}
      >
